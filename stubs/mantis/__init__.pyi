...
__all__: list[str] = ['async_mtx_metadata', 'device_manager', 'errors', 'metadata_errors', 'mrx_channel',
                      'mrx_metadata', 'msdr_params', 'mtx_channel', 'mtx_metadata', 'time_tag', 'utils']
...
class device_manager:
    ...
    def get_rx_channel(self, msdr_params: msdr_params, channel_num: typing.SupportsInt | typing.SupportsIndex) -> tuple[
        errors.error_code, mrx_channel]:
        """
        Returns (error_code, mrx_channel) for the requested SDR and channel.
        """

    def get_tx_channel(self, msdr_params: msdr_params, channel_num: typing.SupportsInt | typing.SupportsIndex) -> tuple[
        errors.error_code, mtx_channel]:
        """
...
class errors:
    ...
    class error_code:
        ...
        INSUFFICIENT_RX_CHANNELS: typing.ClassVar[
            errors.error_code]  # value = <error_code.INSUFFICIENT_RX_CHANNELS: 11>
        INSUFFICIENT_SDRS_FOUND: typing.ClassVar[errors.error_code]  # value = <error_code.INSUFFICIENT_SDRS_FOUND: 3>
        INSUFFICIENT_TX_CHANNELS: typing.ClassVar[
            errors.error_code]  # value = <error_code.INSUFFICIENT_TX_CHANNELS: 10>
        ...
        PARTIAL_SOCKET_RECV_FAILURE: typing.ClassVar[
            errors.error_code]  # value = <error_code.PARTIAL_SOCKET_RECV_FAILURE: 17>
        PARTIAL_SOCKET_SEND_FAILURE: typing.ClassVar[
            errors.error_code]  # value = <error_code.PARTIAL_SOCKET_SEND_FAILURE: 16>
        POWER_REF_UNAVAILABLE: typing.ClassVar[errors.error_code]  # value = <error_code.POWER_REF_UNAVAILABLE: 12>
        SOCKET_CONECTION_FAILURE: typing.ClassVar[
            errors.error_code]  # value = <error_code.SOCKET_CONECTION_FAILURE: 13>
...
class mrx_channel:
    ...
    def receive(self, buffer: collections.abc.Buffer, metadata: mrx_metadata) -> int:
        """
    ...
    def set_freq(self, freq: typing.SupportsFloat | typing.SupportsIndex,
                 lo: typing.SupportsFloat | typing.SupportsIndex | None = None) -> float:
        ...
...
class mtx_channel:
    ...
    def recv_async_message(self, arg0: async_mtx_metadata,
                           arg1: typing.SupportsFloat | typing.SupportsIndex) -> errors.error_code:
        ...
...
class time_tag:
    ...
    @typing.overload
    def __init__(self, full_secs: typing.SupportsInt | typing.SupportsIndex,
                 frac_secs: typing.SupportsFloat | typing.SupportsIndex) -> None:
        ...
